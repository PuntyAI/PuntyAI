...
PUBLIC_SITE_PATHS = {"/", "/about", "/how-it-works", "/contact", "/glossary", "/calculator", "/terms", "/privacy", "/data-deletion", "/tips", "/stats", "/blog", "/sitemap.xml", "/sitemap-static.xml", "/sitemap-blog.xml", "/sitemap-tips.xml", "/robots.txt", "/llms.txt", "/betfair-tracker", "/papa-rick"}
