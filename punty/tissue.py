...
def _career_multiplier(career_record: str) -> float:
    ...
    # Parse "67: 5-14-13" → starts=67, wins=5
...
def build_tissue(
    ...
    for runner in runners:
        ...
        career_mult = _career_multiplier(career_record)
    ...
    for runner in runners:
        ...
        results[rid] = TissueResult(
            tissue_score=round(tissue_score, 4),
